...
const MAPS = [
    ...
    { id: 'map2', title: 'Сложение до 10', icon: Calculator, desc: 'Простые примеры на сложение' },
    { id: 'map3', title: 'Вычитание до 10', icon: Minus, desc: 'Учимся отнимать' },
    { id: 'map4', title: 'Больше / Меньше', icon: Scale, desc: 'Сравниваем количества' },
    { id: 'map5', title: 'Сложение до 20', icon: Calculator, desc: 'Сложные примеры' },
    { id: 'map6', title: 'Вычитание до 20', icon: Minus, desc: 'Сложное вычитание' },
    { id: 'map7', title: 'Сравнение до 20', icon: Scale, desc: 'Сравнение больших чисел' },
];
